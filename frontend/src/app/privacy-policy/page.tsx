      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8">
          ...
          <div className="prose prose-sm sm:prose max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">2. Information We Collect</h2>
              <h3 className="text-lg font-semibold text-gray-900 mt-4 mb-2">2.1 Personal Information</h3>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">3. How We Use Your Information</h2>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-4 mb-2">4.1 Essential Cookies</h3>
              <p className="text-gray-700 mb-2">We use essential cookies that are necessary for the service to function:</p>
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-4 mb-2">4.2 Analytics Cookies (Requires Consent)</h3>
              <p className="text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                <li>
                  ...
                  <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700 underline">
                    Privacy Policy
                  </a>
                  )
                </li>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">6. Data Retention</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">7. Your Rights (GDPR/CCPA)</h2>
              ...
              <p className="text-gray-700 mt-3">
                ...
                <a href={`mailto:${privacyEmail}`} className="text-primary-600 hover:text-primary-700 underline">
                  {privacyEmail}
                </a>
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">8. Data Security</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">9. International Data Transfers</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">10. Children's Privacy</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">11. Changes to This Policy</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">12. Contact Us</h2>
              <p className="text-gray-700">
