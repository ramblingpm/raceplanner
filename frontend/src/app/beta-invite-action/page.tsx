...
function ActionResultContent() {
  ...
  const getIcon = () => {
    if (status === 'approved') {
      ...
      return (
        <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-warning-subtle mb-4">
      ...
      return (
        <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-error-subtle mb-4">
      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full bg-surface-background rounded-lg shadow-xl p-8 border border-border">
          <div className="text-center mb-6">
            {getIcon()}
            <h2 className="text-2xl font-bold text-text-primary mb-4">{getTitle()}</h2>
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block w-full bg-primary text-primary-foreground text-center py-3 px-4 rounded-lg hover:bg-primary-hover transition-colors font-medium"
            >
              Go to Admin Panel
            </Link>
            <Link
              href="/"
              className="block w-full bg-surface-2 text-text-secondary text-center py-3 px-4 rounded-lg hover:bg-surface-3 transition-colors font-medium"
            >
              Back to Home
            </Link>
          </div>
