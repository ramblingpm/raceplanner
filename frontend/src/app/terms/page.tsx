      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="bg-surface-background rounded-lg shadow-sm p-6 sm:p-8 border border-border">
          ...
          <div className="prose prose-sm sm:prose max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">2. Description of Service</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">3. Beta Testing</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">4. User Accounts</h2>
              <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2">4.1 Account Creation</h3>
              <p className="text-text-secondary">
                To use the Service, you must create an account with a valid email address. You are responsible
                for maintaining the confidentiality of your account credentials.
              </p>

              <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2">4.2 Beta Invite Requirement</h3>
              <p className="text-text-secondary">
                Access to the Service requires a beta invitation. Sharing your invitation or account access
                with others is prohibited.
              </p>

              <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2">4.3 Account Responsibilities</h3>
              <p className="text-text-secondary mb-2">You agree to:</p>
              <ul className="list-disc list-inside text-text-secondary space-y-1 ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">5. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">6. User Content</h2>
              <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2">6.1 Your Data</h3>
              <p className="text-text-secondary">
              ...
              <h3 className="text-lg font-semibold text-text-primary mt-4 mb-2">6.2 Feedback</h3>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">7. Disclaimer of Warranties</h2>
              <p className="text-text-secondary mb-2">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">8. Limitation of Liability</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">9. Indemnification</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">10. Termination</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">11. Pricing and Payment</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">12. Changes to Terms</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">13. Governing Law</h2>
              <p className="text-text-secondary">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">14. Contact Information</h2>
              <p className="text-text-secondary">
                For questions about these Terms, please contact us at:
              </p>
              <p className="text-text-secondary mt-2">
                Email:{' '}
                <a href={`mailto:${supportEmail}`} className="text-text-link hover:text-text-link-hover underline">
                  {supportEmail}
                </a>
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-text-primary mb-3">15. Severability</h2>
              <p className="text-text-secondary">
